...
//        $channel = self::getChannelByOperator($mobile); #根据手机号段获取通道
        ...
        return SmsPesoChuangLanHelper::helper()->send($mobile, $eventId, $values, $sendId);
    }
    ...
    public static function sendMarketing($mobile, $content, $values = [], $sendId = 'CashCat', $eventId = 0) {
        ...
        return SmsPesoChuangLanHelper::helper()->sendMarketing($mobile, $content, $values, $sendId, $eventId);
    }
