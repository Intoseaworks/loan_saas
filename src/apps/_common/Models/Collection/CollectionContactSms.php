 ...
 */
class CollectionContactSms extends Model
{
    use StaticModel;
     ...
     * @var string
     */
    protected $table = 'collection_contact_sms';
    /**
     * 批量赋值白名单
     * @var array
     */
    ...
    public function collectionContact($class = CollectionContact::class)
    {
        return $this->belongsTo($class, 'contact_id');
    }
