...
class NoticeTemplateServer extends BaseService
{
...
//        'sms_voice_captche' => '语音验证码',
    ...
    {
        $datas = NoticeTemplate::model()->getNoticeList($params);
        foreach ($datas as $data) {
            $data->setScenario(NoticeTemplate::SCENARIO_LIST)->getText();
        }
        return $datas;
    }
    ...
    public function getNoticeListAll()
    {
        ...
        $datas = NoticeTemplate::model()->where('app_id',$app->id)->where('status','=',2)->get(['id','title']);
        return $datas;
    }
    ...
    public function createOrUpdate($params)
    {
        ...
        $notice = NoticeTemplate::model()->updateOrCreateModel(NoticeTemplate::SCENARIO_CREATE, ['id' => $noticeId], $params);
