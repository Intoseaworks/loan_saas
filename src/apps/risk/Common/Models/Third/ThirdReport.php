...
/**
 * Risk\Common\Models\Third\ThirdReport
 *
 * @property int $id
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|ThirdReport whereAppId($value)
 ...
 * @mixin \Eloquent
 */
class ThirdReport extends RiskBaseModel
{
    /** @var int 类型：征信报告 */
    ...
    {
        $model = self::getHmReport($userId, $startTime);
    ...
    public static function getHmReport($userId, $startTime = null)
    {
        return ThirdReport::getReport($userId, ThirdReport::TYPE_CREDIT_REPORT, ThirdReport::CHANNEL_HIGH_MARK, $startTime);
    }
