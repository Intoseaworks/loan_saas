...
/**
 * Risk\Common\Models\Third\RequestPacket
 *
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|RequestPacket whereAppId($value)
 ...
 * @mixin \Eloquent
 */
class RequestPacket extends RiskBaseModel
{
    ...
    public static function addHighMarkRequestPacket($appId, $orderId, $url, $requestInfo, $responseInfo, $httpCode = 200, $remark = '')
    {
        $packetAttribute = [
            'app_id' => $appId,
            'relate_id' => $orderId,
    ...
    public static function addExperianRequestPacket($appId, $orderId, $url, $requestInfo, $responseInfo, $httpCode = 200, $remark = '')
    {
        $packetAttribute = [
            'app_id' => $appId,
            'relate_id' => $orderId,
