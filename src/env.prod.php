...
return array_merge(include "env.business.php", [
    ...
    'MAIL_PORT' => '465',
    'MAIL_USERNAME' => 'nio.wang@scoreonetech.com',
    'MAIL_ENCRYPTION' => 'ssl',
    'MAIL_PASSWORD' => 'Wywdn1213',
    // 开发者
    ...
    'RISK_ENDPOINT' => 'https://saas.urupee.in/',
    ...
    // 机审征信总开关
    'RISK_SYSTEM_APPROVE_CREDIT' => 'true',
    ...
    "PAY_RAZORPAY_KEY_ID" => "rzp_live_tJk7p4P7tAO6I8",
    "PAY_RAZORPAY_KEY_SECRET" => "fZ0n4T0LGQguUeJL2odz6KhQ",
    "PAY_RAZORPAY_MY_ACC" => "3434582392983188",
