...
$module = 'api';
//前端访问模块
if ($route = array_get($_SERVER, 'REQUEST_URI')) {
...
if (function_exists('fwrite') && defined('STDOUT')) {
    if ($argv = array_get($_SERVER, 'argv')) {
...
// 添加审批的文件夹
if ($module == 'admin') {
    array_push($config['paths']['yamlAnnotations'], base_path('apps') . "/approve");
}
